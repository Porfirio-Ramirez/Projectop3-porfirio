...
namespace Persistence.Migrations
{
    ...
    [Migration("20260415023822_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persistence.Entities.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Entities.AssetHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Entities.AssetType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Entities.InvestmentAsset", b =>
                {
            ...
            modelBuilder.Entity("Persistence.Entities.InvestmentPortfolio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Entities.Asset", b =>
                {
                    b.HasOne("Persistence.Entities.AssetType", "AssetType")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("Persistence.Entities.AssetHistory", b =>
                {
                    b.HasOne("Persistence.Entities.Asset", "Assets")
            ...
            modelBuilder.Entity("Persistence.Entities.InvestmentAsset", b =>
                {
                    b.HasOne("Persistence.Entities.Asset", "asset")
                        .WithMany("investmentAssets")
                        .HasForeignKey("AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Persistence.Entities.InvestmentPortfolio", "investmentPortfolio")
                        .WithMany("investmentAssets")
